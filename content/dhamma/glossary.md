...
6. **mano** (Skt: manas) — mind (as the sixth sense-base); _the cognitive faculty grasping `dhamma` (mental object); kept distinct from `citta` (mind, heart-mind, VI.f) and `viññāṇa` (consciousness, VI.b)._
